...
import com.william.batch.processor.RecordProcessor;
...
public class BatchConfiguration {
    ...
    @Bean
    public Step step1(StepBuilderFactory stepBuilderFactory, ItemReader<RecordSO> reader,ItemWriter<WriterSO> writer, ItemProcessor<RecordSO, WriterSO> processor) {
